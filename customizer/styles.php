...
if ( ! function_exists( 'robotTheme_customizer_library_build_styles' ) && class_exists( 'Customizer_Library_Styles' ) ) :
/**
 ...
 * @return void
 */
function robotTheme_customizer_library_build_styles() {

    // Primary Color
    $color = 'robotTheme-primary-color';
    ...
    if ( $colormod !== customizer_library_get_default( $color ) ) {
        ...
        Customizer_Library_Styles()->add( array(
        	'selectors' => array(
        		...
        		#main-menu.robotTheme-mobile-menu-standard-color-scheme'
        	),
        	'declarations' => array(
    ...
    // Secondary Color
    $color = 'robotTheme-secondary-color';
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    ...
    // Site Title Font
    $font = 'robotTheme-site-title-font';
    ...
    // Heading Font Color
    $fontcolor = 'robotTheme-heading-font-color';
    ...
    // Body Font Color
    $fontcolor = 'robotTheme-body-font-color';
    $fontcolormod = get_theme_mod( $fontcolor, customizer_library_get_default( $fontcolor ) );
...
add_action( 'customizer_library_styles', 'robotTheme_customizer_library_build_styles' );

if ( ! function_exists( 'robotTheme_customizer_library_styles' ) ) :
/**
 ...
 * @return void
 */
function robotTheme_customizer_library_styles() {
...
add_action( 'wp_head', 'robotTheme_customizer_library_styles', 11 );