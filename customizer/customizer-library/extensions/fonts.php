...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'robotTheme' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'robotTheme' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'robotTheme' ),
		'cyrillic'     => __( 'Cyrillic', 'robotTheme' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'robotTheme' ),
		'devanagari'   => __( 'Devanagari', 'robotTheme' ),
		'greek'        => __( 'Greek', 'robotTheme' ),
		'greek-ext'    => __( 'Greek Extended', 'robotTheme' ),
		'khmer'        => __( 'Khmer', 'robotTheme' ),
		'latin'        => __( 'Latin', 'robotTheme' ),
		'latin-ext'    => __( 'Latin Extended', 'robotTheme' ),
		'vietnamese'   => __( 'Vietnamese', 'robotTheme' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'robotTheme' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'robotTheme' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'robotTheme' ),
