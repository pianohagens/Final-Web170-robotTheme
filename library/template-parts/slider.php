<?php
if ( get_theme_mod( 'robotTheme-slider-type', 'robotTheme-no-slider' ) == 'robotTheme-slider-plugin' ) :
?>
	<div class="slider-container">
		<?php
		if ( get_theme_mod( 'robotTheme-slider-plugin-shortcode', '' ) != '' ) {
			echo do_shortcode( get_theme_mod( 'robotTheme-slider-plugin-shortcode' ) );
		}
		?>
	</div>
<?php
    ...
    if ( get_theme_mod( 'robotTheme-slider-categories', '' ) != '' ) {
